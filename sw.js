const CACHE_NAME = 'explore-build-v27';
const PRECACHE = [
    './style.css',
    './icons.js',
    './manifest.json',
...
self.addEventListener('fetch', (e) => {
    ...
    if (request.destination === 'document' || request.url.includes('game.js?v=55') || request.url.includes('online-manager') || request.url.includes('firebase-init')) {
        e.respondWith(
